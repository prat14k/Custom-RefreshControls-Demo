...
//        scrollView.frame = self.frame
    ...
    func scrollViewDidScroll() {
        if (scrollView?.contentOffset.y)! < CGFloat(integerLiteral: 0) {
            ...
            if y < pullDist {
                ...
                bounceView.wave(y: stopPos - pullDist)
                bounceView.didRelease(y: stopPos - pullDist)
